...
function __parse_navigation92ae1b21d4aa16b775b2de0a795cac4b($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation92ae1b21d4aa16b775b2de0a795cac4b';
...
if(''==''): ?>
    <?php echo __parse_navigation92ae1b21d4aa16b775b2de0a795cac4b($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation92ae1b21d4aa16b775b2de0a795cac4b($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e6f396470,null,false);
 ?>
    <div class="links">
        <?php
