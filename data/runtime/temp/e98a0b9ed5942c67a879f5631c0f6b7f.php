...
function __parse_navigationc40d11bae6d6849a5c4310b28afc3df8($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationc40d11bae6d6849a5c4310b28afc3df8';
...
if(''==''): ?>
    <?php echo __parse_navigationc40d11bae6d6849a5c4310b28afc3df8($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationc40d11bae6d6849a5c4310b28afc3df8($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e6f526541,null,false);
 ?>
    <div class="links">
        <?php
