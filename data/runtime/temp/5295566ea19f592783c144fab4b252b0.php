...
function __parse_navigationbb658f8807a9ab83038982c0d6173d35($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationbb658f8807a9ab83038982c0d6173d35';
...
if(''==''): ?>
    <?php echo __parse_navigationbb658f8807a9ab83038982c0d6173d35($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationbb658f8807a9ab83038982c0d6173d35($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e6f1092d1,null,false);
 ?>
    <div class="links">
        <?php
