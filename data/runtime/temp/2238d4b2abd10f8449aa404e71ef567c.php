...
function __parse_navigatione903b4cf9a4f1ff93eac7f35137f72cf($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigatione903b4cf9a4f1ff93eac7f35137f72cf';
...
if(''==''): ?>
    <?php echo __parse_navigatione903b4cf9a4f1ff93eac7f35137f72cf($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigatione903b4cf9a4f1ff93eac7f35137f72cf($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e6f5c880a,null,false);
 ?>
    <div class="links">
        <?php
