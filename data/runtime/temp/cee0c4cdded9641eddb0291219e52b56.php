...
function __parse_navigation28faaa77444770e1cd8c6bdd8681fd0f($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation28faaa77444770e1cd8c6bdd8681fd0f';
...
if(''==''): ?>
    <?php echo __parse_navigation28faaa77444770e1cd8c6bdd8681fd0f($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation28faaa77444770e1cd8c6bdd8681fd0f($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e6f2d3001,null,false);
 ?>
    <div class="links">
        <?php
