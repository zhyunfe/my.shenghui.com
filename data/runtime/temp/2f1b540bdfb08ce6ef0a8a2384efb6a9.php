...
<script src="__STATIC__/js/wind.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5a18e8ae1e274,null,false);
 ?>
</head>
...
function __parse_navigation130ff4296e9d03ad372870d912834401($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation130ff4296e9d03ad372870d912834401';
...
if(''==''): ?>
    <?php echo __parse_navigation130ff4296e9d03ad372870d912834401($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation130ff4296e9d03ad372870d912834401($menus); ?>
    </>
<?php endif; ?>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_1171030022__=1;$__FOR_END_1171030022__=$rows;for($row=$__FOR_START_1171030022__;$row <= $__FOR_END_1171030022__;$row+=1){ 
                $first_row = ($row-1)*3;
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e8ae1e2c4,null,false);
 ?>
    <div class="links">
        <?php
...
<?php 
    \think\Hook::listen('before_body_end',$temp5a18e8ae1e2df,null,false);
 ?>
</body>
</html>
