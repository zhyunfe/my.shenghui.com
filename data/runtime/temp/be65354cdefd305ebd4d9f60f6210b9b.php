...
function __parse_navigation57a44ad84e968e185e52189a8c25385c($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation57a44ad84e968e185e52189a8c25385c';
...
if(''==''): ?>
    <?php echo __parse_navigation57a44ad84e968e185e52189a8c25385c($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation57a44ad84e968e185e52189a8c25385c($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a18e6f46112d,null,false);
 ?>
    <div class="links">
        <?php
